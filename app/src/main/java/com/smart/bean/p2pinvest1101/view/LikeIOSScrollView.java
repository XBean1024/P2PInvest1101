...
import com.smart.bean.p2pinvest1101.util.DensityUtil;
...
public class LikeIOSScrollView extends ScrollView {
    ...
    public LikeIOSScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LikeIOSScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(absY > absX && absY >= DensityUtil.dip2px(10)){
